  ...
  return (
    <div className='text-[#b0b2c3] -mt-10 flex items-center justify-center relative'>
        <div className='max-w-screen-2xl mx-auto w-full px-4'>
            ...
            <p className='font=[Merriweather] italic mb-8 mr-8 '>Software Developer / Full Stack Developer</p>
      ...
      <ul className='text-3xl ml-auto flex flex-col gap-6 absolute right-8 '>
        ...
        <a className='hover:text-white hover:scale-110' target='_blank' href="https://leetcode.com/u/DeepakDshr/"><li ><SiLeetcode /></li></a>
